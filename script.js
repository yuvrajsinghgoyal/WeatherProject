...
//https://api.openweathermap.org/data/2.5/weather?q=bhopal,ind&APPID=d8f2dc010d60963f8edc9c0b4a7bc21e
async function checkWeather(city) {
    ...
    if(response.status==404){
        ...
        document.querySelector('.temp').innerHTML= Math.round(data.coord.lat) +' °C';
